...
class TextMenu:
    ...
    class MyTeachersProfile:
        ...
        ti_profile_lessons_add_delete = {
            "ru": "📚🛒 <b>Добавить/Убрать предметы</b>",
            "en": "📚🛒 <b>Add/Remove lessons</b>",
            "cz": "📚🛒 <b>Přidat/Odstranit předměty</b>",
            "ua": "📚🛒 <b>Додати/Видалити предмети</b>"
            }

        ti_profile_edit = {
            "ru": "✍ <b>Редактировать профиль</b>",
            "en": "✍ <b>Edit profile</b>",
            "cz": "✍ <b>Upravit profil</b>",
            "ua": "✍ <b>Редагувати профіль</b>"
            }
